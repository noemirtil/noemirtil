...
def test_index(client, auth):
    ...
    # All the blog views use the auth fixture from conftest.py. Call auth.login() and subsequent requests from the client will be logged in as the test user.
    auth.login()
    response = client.get('/')
...
def test_create_update_validate(client, auth, path):
    ...
    # The create and update views should show an error message on invalid data.
